    ...
    static class Seed {
        ...
        public String toString() {
            return name + " | Season: " + season +
                    ...
                    "\nRainfall: " + minRainfall + "-" + maxRainfall + " mm" +
                    "\npH: " + minPH + "-" + maxPH +
                    "\nCost: ₹" + productionCost + "/acre" +
        ...
        public static List<Seed> getRecommendations(String soilType, double temperature, double humidity) {
            ...
            for (Seed seed : seeds) {
                if (
                        seed.suitableSoil.equals(soilType) &&
        ...
        // ✅ Sample seed data
        public static List<Seed> initializeSeedDatabase() {
            List<Seed> seeds = new ArrayList<>();

            seeds.add(new Seed("Wheat", 15, 25, 40, 60, 50, 100, 6.0, 7.5,
                    "alluvial", "Rabi", 5000, 2000, 20));
            seeds.add(new Seed("Rice", 20, 35, 60, 90, 100, 200, 5.5, 7.0,
                    "black", "Kharif", 6000, 1800, 25));
            seeds.add(new Seed("Maize", 18, 30, 40, 70, 75, 125, 5.8, 7.2,
                    "red", "Kharif", 4000, 1600, 18));
            seeds.add(new Seed("Barley", 12, 22, 30, 55, 40, 90, 6.0, 7.8,
                    "alluvial", "Rabi", 4000, 1500, 17));
            seeds.add(new Seed("Bajra", 25, 38, 30, 50, 50, 100, 6.2, 8.0,
                    "desert", "Kharif", 3500, 1400, 22));
